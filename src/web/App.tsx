...
export const App = () => {
  ...
  return (
    <div className="mx-auto max-w-[1600px] space-y-4 p-4 pt-[max(1rem,env(safe-area-inset-top))] pb-24 sm:pb-4 [@media(display-mode:standalone)]:pt-[calc(env(safe-area-inset-top)+2.5rem)]">
